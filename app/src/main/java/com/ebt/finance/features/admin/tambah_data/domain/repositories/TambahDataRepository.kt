...
interface TambahDataRepository {
    ...
    suspend fun postPengeluaran(token: String, data: TambahDataBody): Either<FailedDto, TambahPengeluaranDto>
    suspend fun getJenisPengeluaran(token: String): Either<FailedDto, DistributorDto>
}